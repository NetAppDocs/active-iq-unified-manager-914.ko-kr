...
자세한 내용은 link:../storage-mgmt/task_monitor_metrocluster_configurations.html#monitor-connectivity-issues-in-metrocluster-over-ip-configuration["MetroCluster over IP의 연결 문제를 모니터링합니다"]를 참조하십시오.
