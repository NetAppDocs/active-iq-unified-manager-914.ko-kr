...
[NOTE]
====
"`클러스터형 Data ONTAP 관리를 위한 WFA 팩`"은 WFA 5.1에 포함되어 있으므로 이전처럼 NetAppStorage Automation Store에서 이 팩을 다운로드하여 WFA 서버에 별도로 설치할 필요가 없습니다. https://mysupport.netapp.com/site/products/all/details/ocwfa/downloads-tab["WFA 다운로드"^]
