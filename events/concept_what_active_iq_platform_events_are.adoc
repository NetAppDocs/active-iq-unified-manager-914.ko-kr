...
NetApp Active IQ는 NetApp 하이브리드 클라우드 전반에 걸쳐 스토리지 시스템 운영을 최적화하기 위해 예측 분석 및 사전 예방적 지원을 제공하는 클라우드 기반 서비스입니다. 자세한 내용은 https://docs.netapp.com/us-en/active-iq/index.html["NetApp Active IQ를 참조하십시오"^]을 참조하십시오.
